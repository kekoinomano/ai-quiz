...
function ai_quiz_redirect_on_activation() {
...
add_action('admin_init', 'ai_quiz_redirect_on_activation');


function ai_quiz_notice() {
    // Comprobar si el plugin se acaba de activar
    if (get_option('ai_quiz_just_activated')) {
        ?>
